 ...
 * @author sebas
 */
@FacesValidator(value="correoValidator") //Nombre con el que se le llamara desde el XHTML
public class CorreoValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        String regularExpresion = "^[a-zA-Z]([\\w]*[a-zA-Z0-9])*@[a-zA-Z]+[.][a-zA-Z]+";
        String msjError = "El correo ".concat((String) value).concat(" no es valido, ingrese un correo valido.");
